...
[PublicAPI]
public class BuildpackTestContext
{
    ...
    public static BuildpackTestContext Generate(AbsolutePath appPath, CloudFoundryStack stack, [CallerMemberName]string callingMethod = "test")
    {
        ...
        var context = new BuildpackTestContext
        {
